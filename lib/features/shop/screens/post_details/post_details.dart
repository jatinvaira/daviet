...
import 'package:daviet/features/shop/screens/post_details/widgets/bottom_add_to_cart_widget.dart';
                ...
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      IconButton(onPressed: () => Get.to(() => const StudentReviewScreen()), icon: const Icon(Iconsax.arrow_right_3, size: 18,))
                    ],
                  ),
